        ...
        <div class="col-xs-12 col-sm-12 col-md-9 col-truyen-main">
            <div class="list list-truyen col-xs-12">
                <div class="title-list">
                    ...
                    @if($data['alias'] != route('list.story.full'))
                        <div class="filter"><a href="?filter=full">Show complete story only (full)</a></div>
                    @endif
                ...
                @foreach( $data['stories'] as $story)
                    <div class="row" itemscope="">
                        <div class="col-xs-3">
                            <div>
                                <img class="visible-xs-block" src="{{ url(imageThumb($story->image, false)) }}" alt="{{ $story->name  }}">
                                <img class="visible-sm-block visible-md-block visible-lg-block" src="{{ asset(imageThumb($story->image, true)) }}" alt="{{ $story->name  }}">
                            </div>
                        </div>
                        <div class="col-xs-7">
                            <div>
