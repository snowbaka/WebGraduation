...
@section('content')
    ...
    <div class="container visible-md-block visible-lg-block" id="intro-index">
        <div class="title-list">
            <h2><a href="{{route('list.story.hot')}}" title="Hot stories">Hot stories <span class="glyphicon glyphicon-fire"></span></a></h2>
    ...
    <div class="container" id="list-index">
      @include('partials.reading')
        <div class="list list-truyen list-new col-xs-12 col-sm-12 col-md-8 col-truyen-main">
            <div class="title-list">
                <h2><a href="{{route('list.story.new')}}" title="Truyện mới">New stories updated <span class="glyphicon glyphicon-menu-right"></span></a></h2>
