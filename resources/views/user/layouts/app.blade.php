        ...
        <div class="container">
            ...
            <ul class="col-xs-12 col-sm-7 list-unstyled">
                <li class="text-right pull-right">
                    <a href="{{url('contact')}}" title="Liên hệ">Contact</a> - <a href="{{url('tos')}}" title="Terms of Service">Rules</a><a class="backtop" href="#backOnTop" rel="nofollow"><span class="glyphicon glyphicon-upload"></span></a>
                </li>
