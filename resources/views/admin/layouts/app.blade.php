                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <p>
                                    Account name : {{ \Auth::user() ? \Auth::user()->name : '' }}
    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            <ul class="sidebar-menu navigation" data-widget="tree">
                ...
                <li class="{{ isset($home) ? 'active menu-open' : '' }}"><a href="{{ route('admin.home') }}"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
                @endif
                @if($level == 2 | $level == 3)
                <li class="{{ isset($category_menu) ? 'active menu-open' : '' }}"><a href="{{ route('admin.category.index') }}"><i class="fa fa-folder-o"></i> <span>Categories</span></a></li>
                @endif
                @if($level == 2 | $level == 3)
                <li class="{{ isset($author_menu) ? 'active menu-open' : '' }}"><a href="{{ route('admin.author.index') }}"><i class="fa fa-user"></i> <span>Author</span></a></li>
                @endif
                @if($level == 1 || $level == 2 | $level == 3)
                <li class="treeview">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{ route('admin.story.index') }}"><i class="fa fa-circle-o"></i> List of stories</a></li>
                        <li><a href="{{ route('admin.chapter.index') }}"><i class="fa fa-circle-o"></i> List of chapters</a></li>
                        <li><a href="{{ route('admin.story.create') }}"><i class="fa fa-circle-o"></i> Add new stories</a></li>
                        @if(isset($story))
                ...
                @endif
                @if($level == 3)
                <li class="{{ isset($user_menu) ? 'active menu-open' : '' }}"><a href="{{ route('admin.user.index') }}"><i class="fa fa-lock fa-fw"></i> Member</a></li>
                <li class="{{ isset($settings) ? 'active menu-open' : '' }}"><a href="{{ route('admin.setting.index') }}"><i class="fa fa-cog"></i> System installation</a></li>
                {{--<li><a href="{{ route('admin.setting.ads') }}"><i class="fa fa-money"></i> Quản lý quảng cáo</a></li>--}}
                <li><a href="{{ route('admin.setting.tos') }}"><i class="fa fa-pencil"></i> Modify terms</a></li>
