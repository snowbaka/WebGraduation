...
Route::group(['namespace' => 'ControllerUser', 'middleware' => 'web'], function (){
    ...
    // Index List
    Route::get('category/{category}', 'StoryController@getListByCategory')->name('category.list.index');
    Route::get('author/{author}', 'StoryController@getListByAuthor')->name('author.list.index');
    Route::group(['prefix' => 'list'], function() {
        Route::get('story-hot', 'StoryController@getListHotStory')->name('list.story.hot');
        Route::get('story-new', 'StoryController@getListNewStory')->name('list.story.new');
        Route::get('story-full', 'StoryController@getListFullStory')->name('list.story.full');
    });
    Route::get('search', 'StoryController@getListBySearch')->name('list.search');
    // API
