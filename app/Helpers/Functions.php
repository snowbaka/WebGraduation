...
/**
 * change the page title to unsigned format
 * @param $title
...
{
    $status = ['Updating', 'Finish', 'Stop updating', 'Draft'];
    return $status[$id];
}
 ...
 * @param object $data string of category
 * @param string $limit separator
